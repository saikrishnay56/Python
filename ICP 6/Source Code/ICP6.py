...
#From the map, at k=9 seem like data slowly unchange => choose k=9
#Silhouette score
...
print()
print('Silhouette score for',9,'clusters',score)
...
print('Silhouette score for',9,'clusters after scaled',score)
###########################################################################
#Apply PCA
#scale the features
